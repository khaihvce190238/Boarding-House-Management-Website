            ...
            <div class="card info-card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="row g-3 text-center">
                        <div class="col-6"><div class="fw-bold fs-4 text-primary">${tenants.size()}</div><div class="text-muted small">Tenants</div></div>
                        <div class="col-6"><div class="fw-bold fs-4 text-success">${bills.size()}</div><div class="text-muted small">Bills</div></div>
                    </div>
                </div>
            </div>
        </div>
